...
class Respawn():
    ...
    def getPosition(self, position_check=True, delete=False):        #position_check，检查新的目标点是否与障碍物碰撞，False，取初始化目标点，True，检查
        goal_num=0
        import os
            ...
            while position_check:
                ...
                # goal_num=random.randrange(1,5)
                   ...
                   # print(goal_x,goal_y)
                    #self.num+=1                                                                                                                                                        
                #else:
                goal_num=random.randrange(1,8)
                   #print('random')
                   #self.num+=1
                # goal_num=random.randrange(1,4)
                #goal_num=6
                #print(goal_num)
                if goal_num == 1:
                   goal_x = random.randrange(-7, 14) / 10.0
                   goal_y = random.randrange(-22, 20) / 10.0
                if goal_num == 2:
                   goal_x = random.randrange(-26, 8) / 10.0
                   goal_y = random.randrange(-39, -27) / 10.0
                if goal_num == 3:
                   goal_x = random.randrange(-27, -13) / 10.0
                   goal_y = random.randrange(-39, -12) / 10.0
                if goal_num == 4:
                   goal_x = random.randrange(-56, -15) / 10.0
                   goal_y = random.randrange(-5, 20) / 10.0
                if goal_num == 5:
                   goal_x = random.randrange(-56, -34) / 10.0
                   goal_y = random.randrange(-39, -12) / 10.0
                if goal_num == 6:
                   goal_x = random.randrange(21, 33) / 10.0
                   goal_y = random.randrange(-22, 20)  / 10.0
                if goal_num == 7:
                   goal_x = random.randrange(15, 33)  / 10.0
                   goal_y = random.randrange(-39, -29) / 10.0
